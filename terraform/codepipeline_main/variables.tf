...
variable "test_codedeploy_app_name" {
  description = "CodeDeploy application for the test environment."
  type        = string
}

variable "test_deployment_group_name" {
  description = "CodeDeploy deployment group for the test environment."
  type        = string
}

variable "prod_codedeploy_app_name" {
  description = "CodeDeploy application for the prod environment."
  type        = string
}

variable "prod_deployment_group_name" {
  description = "CodeDeploy deployment group for the prod environment."
  type        = string
}
